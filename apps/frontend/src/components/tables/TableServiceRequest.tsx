            ...
            <div className="w-full px-8 flex flex-row justify-between">
                <div className="flex flex-row">
                    <button
                        ...
                        className="bg-mgbblue hover:bg-blue-950 text-white px-4 py-2 rounded text-sm"
                    >
                        Filters
                    </button>
                    {filter && (
                ...
                <div className="flex flex-row">
                    <button className="bg-mgbblue hover:bg-blue-950 text-white px-4 py-2 rounded text-sm">New Request +</button>
                </div>
            </div>
