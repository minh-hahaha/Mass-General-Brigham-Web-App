...
const availableFloors: Floor[] = [
    // 20 Patriot Place
    { id: "20PP-1", label: "1", building: "20PP", svgPath: "/20PPFloor1.svg" },
    { id: "20PP-2", label: "2", building: "20PP", svgPath: "/20PPFloor2.svg" },
    { id: "20PP-3", label: "3", building: "20PP", svgPath: "/20PPFloor3.svg" },
    { id: "20PP-4", label: "4", building: "20PP", svgPath: "/20PPFloor4.svg" },

    // 22 Patriot Place
    { id: "22PP-3", label: "3", building: "22PP", svgPath: "/22PPFloor3.svg" },
    { id: "22PP-4", label: "4", building: "22PP", svgPath: "/22PPFloor4.svg" },

    // Chestnut Hill
    { id: "CH-1", label: "1", building: "CH", svgPath: "/CHFloor1.svg" },
];
...
const HospitalMapComponent = ({startNode, endNode}:Props) => {
    ...
    const [currentFloorId, setCurrentFloorId] = useState<string>("20PP-1");
    ...
    const currentFloorPath = bfsPath.filter(
        node => node.buildingId === currentBuilding && node.floor === currentFloorNumber
    );
    ...
    const hasTransitions = floorTransitions[`${currentBuilding}$-${currentFloor}$`]?.length > 0;
    ...
    return (
        <div className="relative w-full h-full">
            ...
            <div className="absolute top-6 right-6 p-3 bg-white rounded-md shadow-md z-10">
                <h3 className="font-semibold mb-1 text-sm">{currentBuilding} Floor {currentFloorNumber}</h3>
                    ...
                    {hasTransitions && (
                        <div>
                            ...
                            <ul className="list-disc pl-4">
                                {floorTransitions[`${currentBuilding}-${currentFloorNumber}`].map((targetFloor, i) => {
